...
this.orderContentNode=document.getElementById("order__content"),this.orderBasketNode=document.getElementById("order__basket"),this.ordersNode=document.getElementById("orders"),this.ordersListNode=document.getElementById("orders__list")}generateDropdown(e,t){if(0!==e.length)return this.dropdown.innerHTML=e.map(e=>{let{id:i}=e,r=t.find(e=>e.id===i)||[];return`
  ...
  `}).join("")}generateCartItems(e,t,i){return i?this.shopingCart.innerHTML=`
    ...
    `}renderOrderLink(e){this.ordersListNode.innerHTML=e.map(e=>{let{order:t}=e;return t.map(e=>`
        <li class="orders__list-item">
          <a href="#" class="orders__list-number" data-action="openOrder" id="${e.id}">${this.parseDate(+e.id,e.id)}</a>
        </li>
        `)}).join("")}}});