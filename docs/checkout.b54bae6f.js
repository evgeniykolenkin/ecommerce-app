function e(e,t,i,r){Object.defineProperty(e,t,{get:i,set:r,enumerable:!0,configurable:!0})}var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},i={},r={},n=t.parcelRequire398c;null==n&&((n=function(e){if(e in i)return i[e].exports;if(e in r){var t=r[e];delete r[e];var n={id:e,exports:{}};return i[e]=n,t.call(n.exports,n,n.exports),n.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){r[e]=t},t.parcelRequire398c=n),n.register("bpkBQ",function(t,i){e(t.exports,"Controller",()=>a);var r=n("euFfb"),s=n("aDWSZ");class a{constructor(){this.model=new r.Model,this.view=new s.View}initShop(){this.view.shop.addEventListener("click",()=>{this.increment(event,".item","plus")}),this.view.shop.addEventListener("click",()=>{this.decrement(event,".item","minus")}),this.view.shop.addEventListener("click",()=>{this.openCardPopup(event)}),this.view.popupCardNode.addEventListener("click",()=>{this.closePopup(event,"close")}),this.view.popupCardNode.addEventListener("click",()=>{this.addToCart(event)}),this.view.ordersListNode.addEventListener("click",()=>{this.openOrder(event)}),this.view.generateShop(this.model.shopList,this.model.basket,!0),this.model.getProducts().then(e=>{this.model.update(e),this.view.generateShop(this.model.shopList,this.model.basket),this.view.generateDropdown(this.model.basket,this.model.shopList)}),this.view.renderOrderLink(this.model.orders),this.calculation()}initCart(){this.view.shopingCart.addEventListener("click",()=>{this.increment(event,".cart__item","plus")}),this.view.shopingCart.addEventListener("click",()=>{this.decrement(event,".cart__item","minus")}),this.view.shopingCart.addEventListener("click",()=>{this.deleteCard(event,".cart__item","cross")}),this.view.label.addEventListener("click",()=>{this.clearCart(event,"clear")}),this.view.generateCartItems(this.model.basket,this.model.shopList,!0),this.model.getProducts().then(e=>{this.model.update(e),this.view.generateCartItems(this.model.basket,this.model.shopList),this.getTotal()}),this.calculation()}initCheckout(){this.view.saveAddressData.addEventListener("click",()=>{this.saveAdressData(event)}),this.view.paymentDataContent.addEventListener("click",()=>{this.choosePaymentMethod(event)}),this.view.addressPopupData.addEventListener("click",()=>{this.closeChangeAddressPopup(event)}),this.view.paymentPopupData.addEventListener("click",()=>{this.closeChangePaymentPopup(event)}),this.view.changeAddressBtn.addEventListener("click",()=>{this.openChangeAddressPopup()}),this.view.changePaymentBtn.addEventListener("click",()=>{this.openChangePaymentPopup()}),this.view.label.addEventListener("click",()=>{this.sendOrder(event)}),this.model.getProducts().then(e=>{this.model.update(e),this.view.renderCheckoutPage(this.model.basket,this.model.shopList),this.getResult()}),this.calculation()}initOrder(){this.model.getProducts().then(e=>{this.model.update(e),this.view.renderOrderData(this.model.orders,this.model.shopList)})}increment(e,t,i){let r=e.target.closest(t),n=document.querySelector(".dropdown");if(null!==r){let t=r.id,s=this.model.basket.find(e=>e.id===t);if(e.target.dataset.action===i){if(void 0===s)this.model.basket.push({id:t,amount:1}),this.model.setLocalStorage(),this.update(t),this.view.generateDropdown(this.model.basket,this.model.shopList);else{if(s.amount+=1,this.update(t),this.model.setLocalStorage(),!n)return;this.view.generateDropdown(this.model.basket,this.model.shopList)}}}}decrement(e,t,i){let r=e.target.closest(t),n=document.querySelector(".dropdown");if(null!==r){let t=r.id,s=this.model.basket.find(e=>e.id===t);if(e.target.dataset.action===i){if(void 0===s)return;if(s.amount>0){if(s.amount-=1,this.update(t),this.model.basket=this.model.basket.filter(e=>0!==e.amount),this.model.setLocalStorage(),!n)return;this.view.generateDropdown(this.model.basket,this.model.shopList)}}}}deleteCard(e,t,i){let r=e.target.closest(t),n=r.id;e.target.dataset.action===i&&(this.model.basket=this.model.basket.filter(e=>e.id!==n)),this.view.generateCartItems(this.model.basket,this.model.shopList),this.getTotal(),this.calculation(),this.model.setLocalStorage()}clearCart(e,t){e.target.dataset.action===t&&(this.model.basket=[],this.view.generateCartItems(this.model.basket,this.model.shopList),this.calculation(),this.model.setLocalStorage())}getTotal(){if(0!==this.model.basket.length){let e=this.model.basket.map(e=>{let{id:t,amount:i}=e,r=this.model.shopList.find(e=>e.id===t)||[];return i*r.price}).reduce((e,t)=>t+=e,0),t=Number(e+6.99).toFixed(2);this.view.label.innerHTML=`
        ...
        `}}update(e){let t=this.model.basket.find(t=>t.id===e),i=document.getElementById(e),r=i.querySelector(".quantity");r.innerHTML=t.amount,this.calculation()}calculation(){this.view.cartIcon.innerHTML=this.model.basket.map(e=>e.amount).reduce((e,t)=>t+=e,0)}togglePopup(){this.view.popupCardNode.classList.toggle("popup__open"),this.view.bodyNode.classList.toggle("body__fixed")}openCardPopup(e){let t=e.target.closest(".item");null!==t&&"show"===e.target.dataset.action&&(this.view.renderPopupCard(event,this.model.shopList),this.togglePopup())}openChangeAddressPopup(){this.view.addressPopupData.classList.toggle("checkout__popup-open"),this.view.bodyNode.classList.toggle("body__fixed")}saveAdressData(e){e.preventDefault(),this.view.addressNamePopup.value.trim()&&this.view.addressStreetPopup.value.trim()&&this.view.addressCityPopup.value.trim()&&this.view.addressPhonePopup.value.trim()&&(this.view.addressNameData.innerHTML=this.view.addressNamePopup.value.trim(),this.view.addressStreetData.innerHTML=this.view.addressStreetPopup.value.trim(),this.view.addressCityData.innerHTML=this.view.addressCityPopup.value.trim(),this.view.addressPhoneData.innerHTML=this.view.addressPhonePopup.value.trim(),this.view.addressPopupData.classList.toggle("checkout__popup-open"),this.view.bodyNode.classList.toggle("body__fixed")),this.view.addressNamePopup.value.trim()?this.view.addressNamePopup.classList.remove("checkout__sign"):this.view.addressNamePopup.classList.add("checkout__sign"),this.view.addressStreetPopup.value.trim()?this.view.addressStreetPopup.classList.remove("checkout__sign"):this.view.addressStreetPopup.classList.add("checkout__sign"),this.view.addressCityPopup.value.trim()?this.view.addressCityPopup.classList.remove("checkout__sign"):this.view.addressCityPopup.classList.add("checkout__sign"),this.view.addressPhonePopup.value.trim()?this.view.addressPhonePopup.classList.remove("checkout__sign"):this.view.addressPhonePopup.classList.add("checkout__sign")}closeChangeAddressPopup(e){let t=!e.composedPath().includes(this.view.addressPopupContent);t&&(this.view.addressPopupData.classList.toggle("checkout__popup-open"),this.view.bodyNode.classList.toggle("body__fixed"))}openChangePaymentPopup(){this.view.paymentPopupData.classList.toggle("payment__popup-open"),this.view.bodyNode.classList.toggle("body__fixed")}closeChangePaymentPopup(e){let t=!e.composedPath().includes(this.view.paymentDataContent);t&&(this.view.paymentPopupData.classList.toggle("payment__popup-open"),this.view.bodyNode.classList.toggle("body__fixed"))}choosePaymentMethod(e){return"cardpay"===e.target.dataset.action?(this.model.payMethod="card",this.view.paymentDataDefault.classList.add("hidden"),this.view.paymentDataCash.classList.add("hidden"),this.view.cashInputNode.checked=!1,this.view.paymentDataCard.classList.remove("hidden"),this.view.paymentPopupData.classList.toggle("payment__popup-open"),this.view.bodyNode.classList.toggle("body__fixed"),this.model.payMethod):"cashpay"===e.target.dataset.action?(this.model.payMethod="cash",this.view.paymentDataDefault.classList.add("hidden"),this.view.paymentDataCard.classList.add("hidden"),this.view.cardInputNode.checked=!1,this.view.paymentDataCash.classList.remove("hidden"),this.view.paymentPopupData.classList.toggle("payment__popup-open"),this.view.bodyNode.classList.toggle("body__fixed"),this.payMethod):void 0}addToCart(e){let t=e.target.closest(".popup__content");if("add"===e.target.dataset.action){let e=t.querySelector(".popup__btn-add"),i=e.id,r=this.model.basket.find(e=>e.id===i);void 0===r?(this.model.basket.push({id:i,amount:1}),this.model.setLocalStorage(),this.update(i)):(r.amount+=1,this.update(i),this.model.setLocalStorage()),this.view.generateDropdown(this.model.basket,this.model.shopList),this.togglePopup()}}closePopup(e,t){let i=e.target.closest(".popup__content");(null===i||e.target.dataset.action===t)&&this.togglePopup()}sendOrder(e){if("send"===e.target.dataset.action){if(!(this.view.addressNamePopup.value.trim()&&this.view.addressStreetPopup.value.trim()&&this.view.addressCityPopup.value.trim()&&this.view.addressPhonePopup.value.trim())){this.view.addressPopupData.classList.toggle("checkout__popup-open"),this.view.bodyNode.classList.toggle("body__fixed");return}if("nothing"===this.model.payMethod){this.view.paymentPopupData.classList.toggle("payment__popup-open"),this.view.bodyNode.classList.toggle("body__fixed");return}let e=Date.now().toString();this.model.orders.push({order:[{id:e,name:this.view.addressNamePopup.value.trim(),street:this.view.addressStreetPopup.value.trim(),city:this.view.addressCityPopup.value.trim(),phone:this.view.addressPhonePopup.value.trim(),pay:this.model.payMethod,basket:this.model.basket}]}),localStorage.setItem("orderId",e),this.model.setOrderLocalStorage(),this.model.deleteStorageData(),setTimeout(function(){window.location.href="order.html"},500)}}openOrder(e){let t=e.target.closest(".orders__list-item"),i=t.querySelector(".orders__list-number"),r=i.id;"openOrder"===e.target.dataset.action&&localStorage.setItem("orderId",r)}}}),n.register("euFfb",function(t,i){e(t.exports,"Model",()=>l),n("2FRWW");var r=n("S8waa");n("ffXIN");var s=n("eFP9O");let a=(0,r.initializeApp)({apiKey:"AIzaSyCOXDys5ZF3VVDNNg4il1MgFY5tTxpKgE0",authDomain:"ecommerce-app-869b1.firebaseapp.com",projectId:"ecommerce-app-869b1",storageBucket:"ecommerce-app-869b1.appspot.com",messagingSenderId:"159311137942",appId:"1:159311137942:web:ff7a7a73e7426c42b786b7"}),o=(0,s.getFirestore)(a);class l{constructor(){this.orders=this.getOrderLocalStorage(),this.basket=this.getLocalStorage(),this.shopList=[],this.payMethod="nothing"}updateID(e){this.orderId=e}update(e){this.shopList=e}async getProducts(){let e=await (0,s.getDocs)((0,s.collection)(o,"products")),t=[];return e.forEach(e=>{t.push({id:e.id,name:e.data().name,desc:e.data().desc,img:e.data().img,price:e.data().price})}),t}setLocalStorage(){return localStorage.setItem("data",JSON.stringify(this.basket))}getLocalStorage(){let e=localStorage.getItem("data");return JSON.parse(e)||[]}deleteStorageData(){return localStorage.removeItem("data")}setOrderLocalStorage(){return localStorage.setItem("orders",JSON.stringify(this.orders))}getOrderLocalStorage(){let e=localStorage.getItem("orders");return JSON.parse(e)||[]}}}),n.register("2FRWW",function(t,i){e(t.exports,"initializeApp",()=>n("S8waa").initializeApp),e(t.exports,"registerVersion",()=>n("S8waa").registerVersion),/**
 * @license
 ...
 */(0,n("S8waa").registerVersion)("firebase","10.4.0","app")}),n.register("S8waa",function(t,i){e(t.exports,"_registerComponent",()=>m),e(t.exports,"_getProvider",()=>y),e(t.exports,"_removeServiceInstance",()=>v),e(t.exports,"SDK_VERSION",()=>b),e(t.exports,"initializeApp",()=>E),e(t.exports,"getApp",()=>T),e(t.exports,"registerVersion",()=>C);var r=n("eOaSV"),s=n("e66Yi"),a=n("d5F8F"),o=n("4M8bX");/**
 * @license
 ...
 *
 * @public
 */function T(e=d){let t=f.get(e);if(!t&&e===d&&(0,a.getDefaultAppConfig)())return E();if(!t)throw w.create("no-app"/* AppError.NO_APP */,{appName:e});return t}/**
 ...
 */function E(){return"undefined"!=typeof navigator&&"string"==typeof navigator.userAgent?navigator.userAgent:""}/** Returns true if we are running in Safari. */function T(){return!/**
 * Detect Node.js.
 *
...
o.set(e,t)}(t),s(t,r||(r=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])))?new Proxy(t,c):t;return i!==e&&(h.set(e,i),u.set(i,e)),i}let f=e=>u.get(e)}),n.register("ffXIN",function(t,i){e(t.exports,"getFirestore",()=>n("eFP9O").getFirestore),e(t.exports,"getDocs",()=>n("eFP9O").getDocs),e(t.exports,"collection",()=>n("eFP9O").collection),n("eFP9O")}),n.register("eFP9O",function(t,i){e(t.exports,"collection",()=>rH),e(t.exports,"getFirestore",()=>rQ),e(t.exports,"getDocs",()=>ne);var r,s,a=n("S8waa"),o=n("eOaSV"),l=n("e66Yi"),h=n("d5F8F"),u=n("kyPxU");n("9Mq5w");let c="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
/** Not an error; returned on success. */OK:"ok",/** The operation was cancelled (typically by the caller). */CANCELLED:"cancelled",/** Unknown error or an error from a different error domain. */UNKNOWN:"unknown",/**
     ...
     * See litmus test above for deciding between FAILED_PRECONDITION, ABORTED,
     * and UNAVAILABLE.
     */UNAVAILABLE:"unavailable",/** Unrecoverable data loss or corruption. */DATA_LOSS:"data-loss"};/** An error returned by a Firestore operation. */class E extends h.FirebaseError{/** @hideconstructor */constructor(/**
 ...
 */class O{/**
     ...
     */t){if(this.seconds=e,this.nanoseconds=t,t<0||t>=1e9)throw new E(b.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+t);if(e<-62135596800||e>=253402300800)throw new E(b.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e)}/**
...
// sequences (e.g. __id123__) and just passes them through raw (they exist
// for legacy reasons and should not be used frequently).
let t=[];for(let i of e){if(i.indexOf("//")>=0)throw new E(b.INVALID_ARGUMENT,`Invalid segment (${i}). Paths must not contain // in them.`);// Strip leading and traling slashed.
 ...
 */class U extends F{construct(e,t,i){return new U(e,t,i)}/**
     ...
     */static fromServerFormat(e){let t=[],i="",r=0,n=()=>{if(0===i.length)throw new E(b.INVALID_ARGUMENT,`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);t.push(i),i=""},s=!1;for(;r<e.length;){let t=e[r];if("\\"===t){if(r+1===e.length)throw new E(b.INVALID_ARGUMENT,"Path has trailing escape character: "+e);let t=e[r+1];if("\\"!==t&&"."!==t&&"`"!==t)throw new E(b.INVALID_ARGUMENT,"Path has invalid escape sequence: "+e);i+=t,r+=2}else"`"===t?s=!s:"."!==t||s?i+=t:n(),r++}if(n(),s)throw new E(b.INVALID_ARGUMENT,"Unterminated ` in path: "+e);return new U(t)}static emptyPath(){return new U([])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
let t=Object.keys(e.fields||{}).sort(),i="{",r=!0;for(let n of t)r?r=!1:i+=",",i+=`${n}:${e_(e.fields[n])}`;return i+"}"}(e.mapValue):_()}/** Returns true if `value` is an IntegerValue . */function eb(e){return!!e&&"integerValue"in e}/** Returns true if `value` is a DoubleValue. *//** Returns true if `value` is an ArrayValue. */function eE(e){return!!e&&"arrayValue"in e}/** Returns true if `value` is a NullValue. */function eT(e){return!!e&&"nullValue"in e}/** Returns true if `value` is NaN. */function eC(e){return!!e&&"doubleValue"in e&&isNaN(Number(e.doubleValue))}/** Returns true if `value` is a MapValue. */function eS(e){return!!e&&"mapValue"in e}/** Creates a deep copy of `source`. */function eI(e){if(e.geoPointValue)return{geoPointValue:Object.assign({},e.geoPointValue)};if(e.timestampValue&&"object"==typeof e.timestampValue)return{timestampValue:Object.assign({},e.timestampValue)};if(e.mapValue){let t={mapValue:{fields:{}}};return Y(e.mapValue.fields,(e,i)=>t.mapValue.fields[e]=eI(i)),t}if(e.arrayValue){let t={arrayValue:{values:[]}};for(let i=0;i<(e.arrayValue.values||[]).length;++i)t.arrayValue.values[i]=eI(e.arrayValue.values[i]);return t}return Object.assign({},e)}/** Returns true if the Value represents the canonical {@link #MAX_VALUE} . */function eD(e){return"__max__"===(((e.mapValue||{}).fields||{}).__type__||{}).stringValue}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class td extends ta{constructor(e,t){super(),this.serializer=e,this.Te=t}}function tp(e){return eo(e.integerValue||e.doubleValue)}function tf(e){return eE(e)&&e.arrayValue.values?e.arrayValue.values.slice():[]}/**
...
if(null===t)return e.isNoDocument()?new tI(e.key,tg.none()):new tb(e.key,e.data,tg.none());{let i=e.data,r=eA.empty(),n=new ee(U.comparator);for(let e of t.fields)if(!n.has(e)){let t=i.field(e);// If we are deleting a nested field, we take the immediate parent as
...
null===t&&e.length>1&&(e=e.popLast(),t=i.field(e)),null===t?r.delete(e):r.set(e,t),n=n.add(e)}return new tE(e.key,r,new ei(n.toArray()),tg.none())}}/**
 ...
 */function tw(e,t,i,r){return e instanceof tb?function(e,t,i,r){if(!tm(e.precondition,t))// caused a name collision).
...
let n=(i=e,r=t,i instanceof td?/** Returns true if `value` is either an IntegerValue or a DoubleValue. */eb(r)||r&&"doubleValue"in r?r:{integerValue:0}:null),s=tp(n)+tp(e.Te);return eb(n)&&eb(e.Te)?{integerValue:""+s}:/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class tD{/**
     ...
     * backend.
     */applyToRemoteDocument(e,t){let i=t.mutationResults;for(let t=0;t<this.mutations.length;t++){let n=this.mutations[t];if(n.key.isEqual(e.key)){var r;r=i[t],n instanceof tb?function(e,t,i){// Unlike setMutationApplyToLocalView, if we're applying a mutation to a
// remote document the server has accepted the mutation so the precondition
// must have held.
let r=e.value.clone(),n=tC(e.fieldTransforms,t,i.transformResults);r.setAll(n),t.convertToFoundDocument(i.version,r).setHasCommittedMutations()}(n,e,r):n instanceof tE?function(e,t,i){if(!tm(e.precondition,t))// matched on the backend. We therefore must not have the expected version
...
r.has(t.key)&&(void 0===a||a.mutation instanceof tE)?n=n.insert(t.key,t):void 0!==a?(s.set(t.key,a.mutation.getFieldMask()),tw(a.mutation,t,a.mutation.getFieldMask(),O.now())):// Using EMPTY to indicate there is no overlay for the document.
 ...
 */class ib{constructor(/** Manages our in-memory or durable persistence. */e,t,i,r){this.persistence=e,this.ns=t,this.serializer=r,/**
...
// change.
async function iE(e,t){return await e.persistence.runTransaction("Handle user change","readonly",i=>{// Swap out the mutation queue, grabbing the pending mutation batches
// before and after.
...
e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((t,i)=>e[i]=t),i&&i.headers.forEach((t,i)=>e[i]=t)}Do(e,t){let i=ix[e];return`${this.po}/v1/${t}:${i}`}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}vo(e,t,i,r){let n=iL();return new Promise((s,a)=>{let o=new u.XhrIo;o.setWithCredentials(!0),o.listenOnce(u.EventType.COMPLETE,()=>{try{switch(o.getLastErrorCode()){case u.ErrorCode.NO_ERROR:let t=o.getResponseJson();m(iR,`XHR for RPC '${e}' ${n} received:`,JSON.stringify(t)),s(t);break;case u.ErrorCode.TIMEOUT:m(iR,`RPC '${e}' ${n} timed out`),a(new E(b.DEADLINE_EXCEEDED,"Request time out"));break;case u.ErrorCode.HTTP_ERROR:let i=o.getStatus();if(m(iR,`RPC '${e}' ${n} failed with status:`,i,"response text:",o.getResponseText()),i>0){let e=o.getResponseJson();Array.isArray(e)&&(e=e[0]);let t=null==e?void 0:e.error;if(t&&t.status&&t.message){let e=function(e){let t=e.toLowerCase().replace(/_/g,"-");return Object.values(b).indexOf(t)>=0?t:b.UNKNOWN}(t.status);a(new E(e,t.message))}else a(new E(b.UNKNOWN,"Server responded with status "+o.getStatus()))}else // it's most probably a connection issue
a(new E(b.UNAVAILABLE,"Connection failed."));break;default:_()}}finally{m(iR,`RPC '${e}' ${n} completed.`)}});let l=JSON.stringify(r);m(iR,`RPC '${e}' ${n} sending request:`,r),o.send(t,"POST",l,i,15)})}Mo(e,t,i){let n=iL(),s=[this.po,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=(0,u.createWebChannelTransport)(),o=(0,u.getStatEventTarget)(),l={// Required for backend stickiness, routing behavior is based on this
// parameter.
...
return y(d,u.WebChannel.EventType.OPEN,()=>{f||m(iR,`RPC '${e}' stream ${n} transport opened.`)}),y(d,u.WebChannel.EventType.CLOSE,()=>{f||(f=!0,m(iR,`RPC '${e}' stream ${n} transport closed`),g.mo())}),y(d,u.WebChannel.EventType.ERROR,t=>{f||(f=!0,v(iR,`RPC '${e}' stream ${n} transport errored:`,t),g.mo(new E(b.UNAVAILABLE,"The operation could not be completed")))}),y(d,u.WebChannel.EventType.MESSAGE,t=>{var i;if(!f){let s=t.data[0];s||_();// TODO(b/35143891): There is a bug in One Platform that caused errors
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
let t=r[e];if(void 0!==t)return tN(t)}(t),s=a.message;void 0===i&&(i=b.INTERNAL,s="Unknown error status: "+t+" with message "+a.message),f=!0,g.mo(new E(i,s)),d.close()}else m(iR,`RPC '${e}' stream ${n} received:`,s),g.fo(s)}}),y(o,u.Event.STAT_EVENT,t=>{t.stat===u.Stat.PROXY?m(iR,`RPC '${e}' stream ${n} detected buffering proxy`):t.stat===u.Stat.NOPROXY&&m(iR,`RPC '${e}' stream ${n} detected no buffering proxy`)}),setTimeout(()=>{// Technically we could/should wait for the WebChannel opened event,
 ...
 * consumption.
 */class iU extends class{}{constructor(e,t,i,r){super(),this.authCredentials=e,this.appCheckCredentials=t,this.connection=i,this.serializer=r,this.R_=!1}V_(){if(this.R_)throw new E(b.FAILED_PRECONDITION,"The client has already been terminated.")}/** Invokes the provided RPC with auth and AppCheck tokens. */bo(e,t,i){return this.V_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([r,n])=>this.connection.bo(e,t,i,r,n)).catch(e=>{throw"FirebaseError"===e.name?(e.code===b.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),e):new E(b.UNKNOWN,e.toString())})}/** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */Fo(e,t,i,r){return this.V_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([n,s])=>this.connection.Fo(e,t,i,n,s,r)).catch(e=>{throw"FirebaseError"===e.name?(e.code===b.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),e):new E(b.UNKNOWN,e.toString())})}terminate(){this.R_=!0}}/**
 ...
 */function i5(e,t){if(y("AsyncQueue",`${t}: ${e}`),K(e))return new E(b.UNAVAILABLE,`${t}: ${e}`);throw e}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
rb(e,t)})}function rb(e,t){e.ya.delete(t.path.canonicalString());// It's possible that the target already got removed because the query failed. In that case,
// the key won't exist in `limboTargetsByKey`. Only do the cleanup if we still have the target.
let i=e.wa.get(t);null!==i&&(iK(e.remoteStore,i),e.wa=e.wa.remove(t),e.Sa.delete(i),rT(e))}function rE(e,t,i){for(let r of i)r instanceof rl?(e.ba.addReference(r.key,t),function(e,t){let i=t.key,r=i.path.canonicalString();e.wa.get(i)||e.ya.has(r)||(m("SyncEngine","New document in limbo: "+i),e.ya.add(r),rT(e))}(e,r)):r instanceof rh?(m("SyncEngine","Document no longer in limbo: "+r.key),e.ba.removeReference(r.key,t),e.ba.containsKey(r.key)||// We removed the last reference for this key
rb(e,r.key)):_()}/**
 ...
 */function rV(e){if($.isDocumentKey(e))throw new E(b.INVALID_ARGUMENT,`Invalid collection reference. Collection references must have an odd number of segments, but ${e} has ${e.length}.`)}function rB(e,t){if("_delegate"in e&&// Unwrap Compat types
// eslint-disable-next-line @typescript-eslint/no-explicit-any
(e=e._delegate),!(e instanceof t)){if(t.name===e.constructor.name)throw new E(b.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");{let i=/**
 * Returns true if it's a non-null object without a custom prototype
 * (i.e. excludes Array, Date, etc.).
 *//** Returns a string describing the type / value of the provided input. */function(e){if(void 0===e)return"undefined";if(null===e)return"null";if("string"==typeof e)return e.length>20&&(e=`${e.substring(0,20)}...`),JSON.stringify(e);if("number"==typeof e||"boolean"==typeof e)return""+e;if("object"==typeof e){if(e instanceof Array)return"an array";{var t;let i=(t=e).constructor?t.constructor.name:null;return i?`a custom ${i} object`:"an object"}}return"function"==typeof e?"a function":_()}(e);throw new E(b.INVALID_ARGUMENT,`Expected type '${t.name}', but it was: ${i}`)}}return e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e,t,i){if(!i)throw new E(b.INVALID_ARGUMENT,`Function ${e}() cannot be called with an empty ${t}.`)}("collection","path",t),e instanceof r$){let r=V.fromString(t,...i);return rV(r),new rz(e,/* converter= */null,r)}{if(!(e instanceof rq||e instanceof rz))throw new E(b.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");let r=e._path.child(V.fromString(t,...i));return rV(r),new rz(e.firestore,/* converter= */null,r)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class rY{/** @hideconstructor */constructor(e){this._byteString=e}/**
     ...
     */static fromBase64String(e){try{return new rY(en.fromBase64String(e))}catch(e){throw new E(b.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+e)}}/**
 ...
 */class rX{/**
     ...
     */constructor(...e){for(let t=0;t<e.length;++t)if(0===e[t].length)throw new E(b.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new U(e)}/**
 ...
 */class rJ{/**
     ...
     */constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new E(b.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new E(b.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}/**
 ...
 */let rZ=RegExp("[~\\*/\\[\\]]");function r0(e,t,i,r,n){let s=r&&!r.isEmpty(),a=void 0!==n,o=`Function ${t}() called with invalid data`;i&&(o+=" (via `toFirestore()`)"),o+=". ";let l="";return(s||a)&&(l+=" (found",s&&(l+=` in field ${r}`),a&&(l+=` in document ${n}`),l+=")"),new E(b.INVALID_ARGUMENT,o+e+l)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
this.orderContentNode=document.getElementById("order__content"),this.orderBasketNode=document.getElementById("order__basket"),this.ordersListNode=document.getElementById("orders__list")}generateDropdown(e,t){if(0!==e.length)return this.dropdown.innerHTML=e.map(e=>{let{id:i}=e,r=t.find(e=>e.id===i)||[];return`
        ...
        `}).join("");this.dropdown.innerHTML=""}generateShop(e,t,i){return i?this.shop.innerHTML=`
        <div>Загрузка...</div>
      `:this.shop.innerHTML=e.map(e=>{let{id:i,name:r,desc:n,price:s,img:a}=e,o=t.find(e=>e.id===i)||[];return`
      <li class="item" id="${i}">
  ...
  `}).join("")}generateCartItems(e,t,i){return i?this.shopingCart.innerHTML=`
      <div>Загрузка...</div>
      ...
      `)}renderPopupCard(e,t){let i=e.target.closest(".item"),r=i.id,n=t.find(e=>e.id===r),s=this.popupCardNode.innerHTML=`
    ...
    `;return s}renderCheckoutPage(e,t){return this.checkCartNode.innerHTML=e.map(e=>{let{id:i,amount:r}=e,n=t.find(e=>e.id===i)||[];return`
        ...
        `}).join("")}renderOrderData(e,t){let i=localStorage.getItem("orderId");localStorage.setItem("orderId",void 0),this.orderContentNode.innerHTML=e.map(e=>{let{order:t}=e,r=t.find(e=>e.id===i);if(!r)return"";let{id:n,name:s,street:a,city:o,phone:l,pay:h}=r;return`
          ...
          `}).join(""),this.checkCartNode.innerHTML=e.map(e=>{let{order:r}=e,n=r.find(e=>e.id===i);return n?n.basket.map(e=>{let{id:i,amount:r}=e,n=t.find(e=>e.id===i)||[];return`
                <li class="cart__item checkout__cart-item" id="${n.id}">
                  <img src="${n.img}" alt="smth"/>
                  <div class="cart__details">
                    <div class="title__price-x">
              ...
              `}):""}).join("")}parseDate(e,t){let i=new Date(e),r=i.getDate().toString().padStart(2,"0"),n=(i.getMonth()+1).toString().padStart(2,"0"),s=i.getFullYear().toString(),a=i.getHours().toString().padStart(2,"0"),o=i.getMinutes().toString().padStart(2,"0"),l=i.getSeconds().toString().padStart(2,"0");return`
      Заказ <p class="address__order-done">#${t}</p> от ${r}.${n}.${s} ${a}:${o}:${l}
